...
import { CheckCircle, Edit2, Trash2, BookOpen, Clock } from 'lucide-react';
...
export default function SubjectLibrary({ subjects, onToggleGroup, onToggleSection, onEdit, onDelete, onReset, theme, validSchedulesCount }: LibraryProps) {
