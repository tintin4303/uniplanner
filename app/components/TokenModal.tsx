...
export default function TokenModal({ onClose, onStartAdFlow, onBuyTokens }: TokenModalProps) {
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md max-h-[85vh] flex flex-col animate-in zoom-in-95 duration-300">
                ...
                <div className="p-8 pt-2 overflow-y-auto custom-scrollbar">
                    <div className="grid grid-cols-1 gap-6">
                        <div className="border-2 border-dashed border-indigo-200 bg-indigo-50 p-6 rounded-2xl text-center relative overflow-hidden shrink-0">
                            ...
                            <button onClick={onStartAdFlow} className="bg-white border-2 border-indigo-100 hover:border-indigo-300 text-indigo-600 w-full py-2 rounded-xl font-bold shadow-sm transition-all text-sm active:scale-95 cursor-pointer">Watch Now</button>
                        </div>
                        <div className="grid grid-cols-2 gap-4 shrink-0">
                            <div className="border border-slate-200 p-4 rounded-2xl text-center opacity-80 hover:opacity-100 transition-opacity hover:shadow-md">
                                ...
                                <button onClick={() => onBuyTokens('starter')} className="bg-slate-100 hover:bg-slate-200 text-slate-600 w-full py-2 rounded-xl font-bold text-xs transition-colors cursor-pointer">Buy</button>
                            </div>
